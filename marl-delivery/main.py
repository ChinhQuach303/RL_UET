...
def main(map_file='map.txt', max_robots=5, max_packages=10, max_time_steps=50, num_episodes=500, seed=10):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_time_steps", type=int, default=50, help="Maximum time steps per episode")
